...
import com.rhkj.zhihuixue.adapter.CouponExpiredAdapter;
...
public class CouponExpiredFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        strings.add("");
        strings.add("");
        CouponExpiredAdapter couponExpiredAdapter = new CouponExpiredAdapter(strings);
        recyclerView.setAdapter(couponExpiredAdapter);
