...
public class Contents {
    ...
    //登录
    public static final String LOGOIN = BASE + "Index/login";
    //验证码
    public static final String VERICATCODE = BASE + "Index/yzm";
    //获取年级
    public static final String GRADE = BASE + "Index/grade";
    //获取单词级别
